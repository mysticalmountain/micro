 ...
 */
@Component
public class PostExecuteComplex implements ExecuteTemplate<Request, ComplexService, Response> {
    ...
    public Response execute(Request request, ComplexService processor, Object... args) throws ServiceException {
        ...
        log.info("begin request method [POST], uri [" + String.valueOf(args[1]) + "]");
        try {
            ...
            log.info("end request method [POST], uri [" + args[1] + "], time mills:" + (end - begin) + " ms");
        }
    }
}
