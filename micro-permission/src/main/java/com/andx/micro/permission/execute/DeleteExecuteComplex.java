 ...
 */
@Component
public class DeleteExecuteComplex implements ExecuteTemplate<Null, ComplexService, Response> {
    ...
    @Override
    public Response execute(Null aNull, ComplexService processor, Object... args) throws ServiceException {
        ...
        try {
            ...
            Enumeration en = httpServletRequest.getSession().getAttributeNames();
