 ...
 */
@Component
@Service(path = "/roles", code = "newRole", method = "POST", name = "新建角色")
public class NewRoles extends GenericSampleService<Request<RoleDto>, Response<RoleDto>> {
    ...
    @Override
    public Response<RoleDto> doService(Request<RoleDto> roleDtoRequest, Object... args) throws ServiceException {
